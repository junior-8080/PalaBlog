...
export const predictMl = async (data) => {
  const {
    ...
    threshold,
    nnType,
    verifiedEelementType1,
    verifiedEelementType2,
  } = data;
  ...
  formData.append("verified_pokemon_name", pokemonName);
  formData.append("nn_type", mlLirary === "scikit-learn" ? null : nnType);
  formData.append("nn_prediction_threshold",mlLirary === "scikit-learn" ? null : threshold);
  formData.append("verified_element_type_1",verifiedEelementType1);
  formData.append("verified_element_type_2",verifiedEelementType2);
